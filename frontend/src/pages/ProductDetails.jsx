      ...
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden md:flex">
        ...
        <div className="md:w-1/2 p-8 flex flex-col justify-between">
          <div>
            ...
            <p className="text-gray-500 mb-6 leading-relaxed whitespace-pre-line">{product.description}</p>
            <div className="text-3xl font-bold text-blue-600 mb-6">{formattedPrice}</div>
          </div>

          <button 
            onClick={handleQuote}
            className="w-full bg-green-500 hover:bg-green-600 text-white font-bold py-4 rounded-lg flex items-center justify-center gap-2 transition-colors shadow-lg hover:shadow-green-500/30"
          >
            Orçar no WhatsApp
          </button>
        </div>
