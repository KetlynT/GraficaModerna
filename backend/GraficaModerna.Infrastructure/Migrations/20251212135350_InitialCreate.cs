        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RefundType = table.Column<string>(type: "text", nullable: true),
                    RefundRequestedAmount = table.Column<decimal>(type: "numeric", nullable: true),
                    RefundRejectionReason = table.Column<string>(type: "text", nullable: true),
                    RefundRejectionProof = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Order_TotalAmount", "\"TotalAmount\" >= 1.00 AND \"TotalAmount\" <= 100000.00");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CouponUsage_UserId_CouponCode",
                table: "CouponUsages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Product_IsActive_Price",
                table: "Products",
